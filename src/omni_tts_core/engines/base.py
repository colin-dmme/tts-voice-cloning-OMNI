...
class TtsEngineRequest:
    ...
    sentence_pause_min_ms: int = 0
    sentence_pause_max_ms: int = 0
    comma_pause_ms: int = 0
    comma_pause_random_enabled: bool = False
    comma_pause_min_ms: int = 0
    comma_pause_max_ms: int = 0
    clause_pause_ms: int = 0
    clause_pause_random_enabled: bool = False
    clause_pause_min_ms: int = 0
    clause_pause_max_ms: int = 0
    ellipsis_pause_ms: int = 0
    ellipsis_pause_random_enabled: bool = False
    ellipsis_pause_min_ms: int = 0
    ellipsis_pause_max_ms: int = 0
