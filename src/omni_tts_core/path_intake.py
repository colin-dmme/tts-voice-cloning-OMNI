"""Parse file paths from clipboard text / drag-and-drop payloads.

UI-agnostic path intake shared by every GUI. Handles quoted/braced tokens,
tab/semicolon-separated lists, and ``file://`` URLs (incl. Windows drive URLs).
"""
